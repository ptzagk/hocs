...
describe('preventDefault', () => {
  it('should pass props through if there are no arguments', () => {
    const EnchancedTarget = preventDefault()(Target);
    const wrapper = mount(
  ...
  it('should not wrap non-existing handler', () => {
    const EnchancedTarget = preventDefault('testHandler')(Target);
    const wrapper = mount(
      <EnchancedTarget/>
    );
  ...
  describe('display name', () => {
    ...
    it('should wrap display name in non-production env', () => {
      ...
      expect(wrapper.name()).toBe('preventDefault(Target)');
    });
    ...
    it('should not wrap display name in production env', () => {
      ...
      expect(wrapper.name()).toBe('PreventDefault');
    });
  });
});
